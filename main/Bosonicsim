...
Following [[1]], one can check my Julia code for the simulation of logical X gate in bosonic system. By changning the definition of fideity, one could perform other gate sets and encoding process.
