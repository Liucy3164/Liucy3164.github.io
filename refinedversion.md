...
<img src="{{ 'graphs/refined version.png' | relative_url }}" alt="refined version" style="width:100%; max-width:600px; border-radius:12px;" />
...
A key result shows that a second atom passing through the cavity with a coupling strength of `1/sqrt(3)` relative to the first atom leads to a perfect controlled-Z operation.
